...
public class TestConsumer {
    ...
    private final List<CreateArtifactCommand> createArtifactCommands = new CopyOnWriteArrayList<>();

    public List<SharedArchivedArtifactVersionCreatedEvent> getEvents() {
        return events;
    }

    public List<CreateArtifactCommand> getCreateArtifactCommands() {
