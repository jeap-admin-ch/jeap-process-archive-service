...
/**
 * Reference provider for the first remote-data configuration of {@code TestDomain2Event}. Produces a distinct
 ...
 */
public class TestDomain2RemoteReferenceProviderA implements ArchiveDataReferenceProvider<TestDomain2Event> {

    public static final String REFERENCE_ID_SUFFIX = "-remoteA";
