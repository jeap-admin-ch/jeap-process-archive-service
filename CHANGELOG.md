...
### Dependencies
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 9.2.0 → 9.3.0 (minor)
...
### Added
- Added diagnostic logging for the Kafka factory, listener adapter and effective messaging service name used by dynamically created consumers.
- Added regression coverage for listener-related factory configuration on dynamically created Kafka consumers.

## [23.9.0] - 2026-09-06

### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 40.8.0 → 40.9.2 (minor)
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 8.5.0 → 8.6.0 (minor)

## [23.8.0] - 2026-09-03

### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 40.7.0 → 40.8.0 (minor)
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 8.4.0 → 8.5.0 (minor)

## [23.7.0] - 2026-09-02

### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 40.5.1 → 40.7.0 (minor)
- **org.checkerframework:checker-qual**: 4.2.2 → 4.2.3 (patch)

## [23.6.2] - 2026-09-01

### Fixed
- Fixed programmatically created PAS Kafka consumers not inheriting listener configuration from their factory.
...
### Dependencies
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 8.3.1 → 8.4.0 (minor)

## [23.5.0] - 2026-08-28

### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 40.4.0 → 40.5.0 (minor)
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 8.3.0 → 8.3.1 (patch)
...
### Dependencies
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 8.2.1 → 8.3.0 (minor)
...
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 8.0.0 → 8.1.0 (minor)
...
### Dependencies
- **com.networknt:json-schema-validator**: 3.0.6 → 3.0.7 (patch)
...
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 6.5.0 → 7.0.0 (major)
- **org.codehaus.plexus:plexus-xml**: 4.1.1 → 4.2.0 (minor)
- **org.apache.avro:avro-maven-plugin**: 1.12.1 → 1.12.2 (patch)
...
## [20.5.0] - 2026-08-13
### Changed
- update jeap-process-archive-reader from 6.2.0 to 6.5.0
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 38.5.0 → 38.6.0 (minor)

## [20.4.0] - 2026-08-11

### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 38.2.0 → 38.3.0 (minor)
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 6.1.0 → 6.2.0 (minor)
...
### Dependencies
- **org.checkerframework:checker-qual**: 4.2.1 → 4.2.2 (patch)

## [20.2.0] - 2026-08-06

### Dependencies
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 6.0.1 → 6.1.0 (minor)
...
### Dependencies
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 6.0.0 → 6.0.1 (patch)

## [20.0.0] - 2026-08-02

### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 38.0.0 → 38.0.1 (patch)
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 5.3.0 → 6.0.0 (major)

## [19.0.1] - 2026-07-30

### Fixed
- The archive types compiler now fetches the tags of the archive type registry with a Git process pinned to the registry
  repository. Previously the process inherited the working directory of the build and fetched the tags into whatever
  repository enclosed it.

## [19.0.0] - 2026-07-29

### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 37.6.0 → 38.0.0 (major)
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 5.2.0 → 5.3.0 (minor)

## [18.4.0] - 2026-07-26

### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 37.4.0 → 37.6.0 (minor)
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 5.1.0 → 5.2.0 (minor)
- **org.eclipse.jgit:org.eclipse.jgit**: 7.7.0.202606012155-r → 7.7.1.202607240634-r (patch)

## [18.3.0] - 2026-07-23

### Changed
- Renamed the internal `ProcessArchiveReader` bean from `archiveReader` to `processArchiveReader` to prevent a bean name
  collision with the `archiveReader` bean registered by `ProcessArchiveReaderAutoConfiguration` when
  `jeap-process-archive-reader` is included as a dependency in the same service instance.
...
### Dependencies
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 5.0.0 → 5.1.0 (minor)

## [18.0.0] - 2026-07-22

### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 37.0.0 → 37.2.0 (minor)
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 4.5.0 → 5.0.0 (major)
- **ch.admin.bit.jeap:jeap-opensearch-searchitem-model**: 2.0.0 → 2.1.0 (minor)
- **ch.admin.bit.jeap:jeap-opensearch-searchitem-api**: 2.0.0 → 2.1.0 (minor)
- **ch.admin.bit.jeap:jeap-opensearch-index-type**: 1.7.0 → 1.8.0 (minor)

## [17.2.0] - 2026-07-21

### Dependencies
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 4.4.0 → 4.5.0 (minor)

## [17.1.0] - 2026-07-20

### Changed
- Update to jeap-spring-boot-parent 37.0.0 and use the standalone WireMock Spring Boot integration.

## [17.0.0] - 2026-07-18

### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 36.9.0 → 36.10.0 (minor)
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 4.3.0 → 4.4.0 (minor)
- **ch.admin.bit.jeap:jeap-opensearch-searchitem-model**: 1.10.0 → 2.0.0 (major)
- **ch.admin.bit.jeap:jeap-opensearch-searchitem-api**: 1.10.0 → 2.0.0 (major)

## [16.7.0] - 2026-07-17

### Added
- Expose the enabled backfill job endpoints as a dedicated Swagger/OpenAPI group.

## [16.6.0] - 2026-07-15

### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 36.7.0 → 36.9.0 (minor)
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 4.2.0 → 4.3.0 (minor)
- **ch.admin.bit.jeap:jeap-opensearch-searchitem-model**: 1.8.0 → 1.10.0 (minor)
- **ch.admin.bit.jeap:jeap-opensearch-searchitem-api**: 1.8.0 → 1.10.0 (minor)
- **ch.admin.bit.jeap:jeap-opensearch-index-type**: 1.5.0 → 1.7.0 (minor)
- **org.wiremock.integrations:wiremock-spring-boot**: 4.2.1 → 4.2.2 (patch)

## [16.5.0] - 2026-07-13

### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 36.3.1 → 36.7.0 (minor)
- **ch.admin.bit.jeap:jeap-opensearch-searchitem-model**: 1.5.2 → 1.8.0 (minor)
- **ch.admin.bit.jeap:jeap-opensearch-searchitem-api**: 1.5.2 → 1.8.0 (minor)

## [16.4.0] - 2026-07-08
### Changed
- update jeap-process-archive-reader from 4.1.0 to 4.2.0
...
- **ch.admin.bit.jeap:jeap-process-archive-reader**: 4.0.0 → 4.1.0 (minor)
- **ch.admin.bit.jeap:jeap-opensearch-searchitem-model**: 1.5.1 → 1.5.2 (patch)
- **ch.admin.bit.jeap:jeap-opensearch-searchitem-api**: 1.5.1 → 1.5.2 (patch)
- **com.networknt:json-schema-validator**: 3.0.5 → 3.0.6 (patch)

## [16.2.0] - 2026-07-07

### Added

- Made trunk branch name configurable in jeap-process-archive-type-registry-maven-plugin 
...
- Add missing `test` scope to the `spring-boot-starter-test` dependency in `jeap-process-archive-remote-data-provider`
...
### Added
-  Added default properties for the pas-backfill-db module
...
### Added
- Add documentation for backfill jobs

### Changed
- Make the backfill reference version optional
- Use collision-safe idempotence ids for backfill commands with optional reference versions

## [14.1.1] - 2026-06-18

### Added
- Add YAML REST report endpoint for persisted backfill jobs
...
- Update jeap-opensearch from 0.14.0 to 0.18.0

## [13.3.0] - 2026-06-08

### Changed

- Integrate new standard openSearch API for archive data retrieval
...
- update json-schema-validator from 3.0.2 to 3.0.3
- update maven.api from 3.9.12 to 3.9.16
- update maven-plugin-testing-harness 3.5.0 to 3.5.1
...
- Set default for objectStorageProperties.schemaOverwriteAllowed to false, avoiding the storage of duplicate schema
  versions. The avro schema for a certain archive type is immutable.
...
- Test archival condition before extracting process ID from message
...
- Support all message types (events, commands) as archive data triggers/sources
...
- update maven.api from 3.9.10 to 3.9.12
- update maven-plugin-testing-harness from 3.3.0 to 3.5.0
- update wiremock from 3.13.1 to 3.13.2
...
- Breaking Change: remove webflux support
