...
* ch.admin.bit.jeap:
  jeap-process-archive-config-type-repository - [ch.admin.bit.jeap:jeap-process-archive-config-type-repository](https://github.com/jeap-admin-ch/jeap-process-archive-service/tree/main/jeap-process-archive-config-type-repository)
